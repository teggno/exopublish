...
import { updateLuaScript } from "./exosite";

export function publishLua(publishArgs: PublishArgs) {
...
export interface LuaDeviceScript {
    path: string;
    rid: string;
...
function minifyLarge(luaCode: string): string {
